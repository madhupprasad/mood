...
enum ThemeCatalog {
    static let cream = Theme(
        ...
        card: Color(red: 0.99, green: 0.98, blue: 0.95),
    ...
    static let slate = Theme(
        ...
        sidebar: Color(red: 0.078, green: 0.078, blue: 0.082),
        selection: Color(red: 0.20, green: 0.22, blue: 0.25),
        card: Color(red: 0.117, green: 0.117, blue: 0.129),
        primary: Color(red: 0.929, green: 0.929, blue: 0.921),
        secondary: Color(red: 0.604, green: 0.604, blue: 0.596),
        line: Color(white: 1.0, opacity: 0.07),
        accent: Color(red: 0.475, green: 0.690, blue: 0.498),
        logButtonText: Color(red: 0.086, green: 0.086, blue: 0.090),
        isDark: true
    )
    ...
    static let sky = Theme(
        ...
        card: Color(red: 0.99, green: 0.99, blue: 1.00),
    ...
    static let lavender = Theme(
        ...
        card: Color(red: 0.99, green: 0.98, blue: 1.00),
    ...
    static let solar = Theme(
        ...
        card: Color(red: 1.00, green: 0.98, blue: 0.94),
